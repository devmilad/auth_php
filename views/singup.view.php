    ...
    <main class="form-signin w-100 m-auto">
      <form method="POST">
        ...
        <div class="form-floating my-3">
          <input type="text" class="form-control" id="floatingInput" placeholder="devmilad" name="username">
          <label for="floatingInput">Username</label>
          <p class="small text-danger float-start m-1 <?= $data['nameError'] ?? 'd-none' ?>"><?= $data['nameError'] ?></p>
        </div>
        <div class="form-floating my-3">
        ...
        <div class="form-floating my-3">
          ...
          <p class="small text-danger float-start m-1 <?= $data['cpError'] ?? 'd-none' ?>"><?= $data['cpError'] ?></p>
        </div>
    
        <button class="w-100 btn btn-lg btn-primary" type="submit">Sign up</button>
        <a href="controllers/login.php" class="text-decoration-none"><p class="mt-5 mb-3 ">I have a account</p></a>
      </form>
    </main>
